...
st.set_page_config(
    page_title="Seker V2 — AI Design Quality Auditor",
    layout="wide",
    page_icon="🛰️"
)
...
with tabs[1]:
    ...
    yaml_str = st.text_area("Ruleset YAML", value=json.dumps(data, indent=2), height=300, help="For convenience this shows JSON. Use Settings to edit YAML.")
